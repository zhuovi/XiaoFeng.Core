...
namespace XiaoFeng.Redis
{
    ...
    public partial class RedisBaseClient : Disposable
    {
        ...
        public RedisBaseClient(string host = "127.0.0.1", int port = 6379, string password = "", int? MaxPool = null)
        {
        ...
        /// <param name="port">端口</param>
        /// <param name="MaxPool">应用池数量</param>
        public RedisBaseClient(string host, string password, int port = 6379, int? MaxPool = null) : this(host, port, password, MaxPool)
        { }
        /// <summary>
        /// 设置连接串
        /// </summary>
        /// <param name="connectionString">连接串</param>
        public RedisBaseClient(string connectionString)
        {
        ...
        public RedisBaseClient(ConnectionConfig config)  { this.ConnConfig = config.ToRedisConfig(); }
        /// <summary>
        /// 设置配置
        /// </summary>
        /// <param name="config">Redis配置</param>
        public RedisBaseClient(RedisConfig config) { this.ConnConfig = config; }
        #endregion
